...
const struct syscall_hashmap_entry s390x_syscall_hashmap[] = {
#ifndef GENERATING_HASHMAP
#include "arch-s390x-syscall-hashmap.c"
#endif
};
...
int s390x_syscall_resolve_name(const char *name)
{
	...
	return syscall_hashmap_resolve(s390x_syscall_hashmap,
		sizeof(s390x_syscall_hashmap) / sizeof(*s390x_syscall_hashmap), name);
}
