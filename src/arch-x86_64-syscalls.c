...
const struct syscall_hashmap_entry x86_64_syscall_hashmap[] = {
#ifndef GENERATING_HASHMAP
#include "arch-x86_64-syscall-hashmap.c"
#endif
};
...
{
	return syscall_hashmap_resolve(x86_64_syscall_hashmap,
		sizeof(x86_64_syscall_hashmap) / sizeof(*x86_64_syscall_hashmap), name);
}
