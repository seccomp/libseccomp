...
const struct syscall_hashmap_entry x32_syscall_hashmap[] = {
#ifndef GENERATING_HASHMAP
#include "arch-x32-syscall-hashmap.c"
#endif
};
...
{
	return syscall_hashmap_resolve(x32_syscall_hashmap,
		sizeof(x32_syscall_hashmap) / sizeof(*x32_syscall_hashmap), name);
}
